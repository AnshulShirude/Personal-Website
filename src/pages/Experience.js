        ...
        <div className="outer-container">
            <div className="inner-container">
                ...
                <div> 
                    ...
                    <ul>
                        <li>CGI is a Canadian multinational information technology consulting and systems integration company which is among the largest IT and business consulting services firms in the world.</li>
                ...
                <div> 
                    ...
                    <ul>
                        <li>Veea is an edge platform provider headquartered in New York City which has brought a broad range of Wi-Fi, 4G/5G mobile wireless, and IoT products to market over the past two decades.</li>
